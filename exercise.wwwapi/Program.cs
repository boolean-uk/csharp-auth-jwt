...
{
    option.SwaggerDoc("v1", new OpenApiInfo { Title = "Csharp-auth-jwt", Version = "v1" });
...
// these will eventually be moved to a secrets file, but for alpha developent appsettings is fine
