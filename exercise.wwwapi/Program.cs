...
}).AddJwtBearer(x =>
{
    x.TokenValidationParameters = new TokenValidationParameters
    {
        ...
        IssuerSigningKey = new SymmetricSecurityKey(Encoding.UTF8.GetBytes(config.GetValue("AppSettings:Token"))), // reading the long phrase out of appsettings.json
...
// I'm going to allow any access to my API from any origin. So we can call it from a different application
app.UseCors(x => x
                  .AllowAnyMethod()
                  .AllowAnyHeader()
