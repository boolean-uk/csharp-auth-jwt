...
builder.Services.AddSwaggerGen(s =>
{
    ...
    {
        Version = "v1",
        Title = "C# API Authentication HTTP Requests",
        Description = "Blog Post system where the user has to log in before looking at posts or posting/editing stuff",
        ...
        {
            Name = "Cool License",
            Url = new Uri("https://github.com/Yumikitsu/csharp-auth-jwt")
        }
